...
<template>
    ...
    <EditorSelectInput v-else-if="isSelectionPiece(piece)" :value="piece.value" :options="piece.options"
                       @mousedown.stop @changed="$emit('changeSelection', $event)" :placeholder="piece.placeholder" />
